...
axn0.errorbar(xl[:,0]/xl[:,1],xl[:,4],yerr=xl[:,5],marker='s',color='r',ms=15,fillstyle='none',mew=2.5,linestyle='None',label=r'$\dot{\mathcal{T}}_{X_{1}\to X_{3}}^{(\mathrm{A})}$')
axn0.errorbar(xl[:,0]/xl[:,1],xl[:,2],yerr=xl[:,3],marker='x',color='r',ms=15,fillstyle='none',mew=2.5,linestyle='None',label=r'$\dot{\mathcal{T}}_{X_{1}\to X_{2}}^{(\mathrm{A})}$')

axn1.errorbar(xs[:,0]/xs[:,1],xs[:,4],yerr=xs[:,5],marker='s',color='b',ms=15,fillstyle='none',mew=2.5,linestyle='None',label=r'$\dot{\mathcal{T}}_{X_{1}\to X_{3}}^{(\mathrm{B})}$')
axn1.errorbar(xs[:,0]/xs[:,1],xs[:,2],yerr=xs[:,3],marker='x',color='b',ms=15,fillstyle='none',mew=2.5,linestyle='None',label=r'$\dot{\mathcal{T}}_{X_{1}\to X_{2}}^{(\mathrm{B})}$')
...
ax10.errorbar(xl[:,0]/xl[:,1],xl[:,4]/xl[:,2],yerr=xl[:,4]/xl[:,2]*(xl[:,5]**2/xl[:,4]**2+xl[:,3]**2/xl[:,2]**2)**0.5,marker='o',color='r',ms=22,fillstyle='none',mew=2.5,linestyle='None',label=r'Model A')
ax10.errorbar(xs[:,0]/xs[:,1],xs[:,4]/xs[:,2],yerr=xs[:,4]/xs[:,2]*(xs[:,5]**2/xs[:,4]**2+xs[:,3]**2/xs[:,2]**2)**0.5,marker='^',color='b',ms=22,fillstyle='none',mew=2.5,linestyle='None',label=r'Model B')
#ax10.set_xscale('log')
ax10.set_xlim(0,2.1)
